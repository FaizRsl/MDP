            ...
            if message['cat'] == "control":
                if message['value'] == "start":
                    ...
                    if self.small_direction == "Left Arrow": 
                        self.command_queue.put("OB01") # ack_count = 2
                        self.command_queue.put("UL00") # ack_count = 3
                    elif self.small_direction == "Right Arrow":
                        self.command_queue.put("OB01") # ack_count = 2
                        self.command_queue.put("UR00") # ack_count = 3
            ...
            if message.startswith("ACK"):
                ...
                if self.ack_count == 3:
                    ...
                    if self.large_direction == "Left Arrow": 
                        self.command_queue.put("PL01") # ack_count = 4
                    elif self.large_direction == "Right Arrow":
                        self.command_queue.put("PR01") # ack_count = 4
                    else:
                        self.command_queue.put("PR01") # ack_count = 4
